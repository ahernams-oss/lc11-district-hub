        ...
        <div className="flex min-w-0 items-center gap-3 2xl:shrink-0">
          ...
          {governador?.photo_url && (
            <Link
              ...
              className="hidden shrink-0 items-center gap-2 rounded-lg border border-border bg-surface/50 px-2 py-1 transition-colors hover:bg-surface sm:flex lg:px-[calc(0.5rem+0.75cm)]"
