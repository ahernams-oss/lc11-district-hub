        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr]">
          <div className="space-y-5">
            <div className="rounded-xl border border-border bg-card p-6 shadow-card">
              ...
              <p className="mt-1 text-sm text-muted-foreground">contato@distritolc11.org</p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6 shadow-card">
              <Phone className="h-6 w-6 text-primary" />
              <h3 className="mt-3 font-semibold text-foreground">Telefone</h3>
              <p className="mt-1 text-sm text-muted-foreground">(00) 0000-0000</p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6 shadow-card">
              <MapPin className="h-6 w-6 text-primary" />
              <h3 className="mt-3 font-semibold text-foreground">Sede do Distrito</h3>
              <p className="mt-1 text-sm text-muted-foreground">Endereço da sede — Cidade, Estado</p>
            </div>
          </div>
          ...
          >
            {sent ? (
              <div className="py-10 text-center">
                ...
                <p className="mt-2 text-muted-foreground">Em breve um membro do distrito entrará em contato.</p>
              </div>
            ) : (
              <>
                <h2 className="font-display text-2xl font-bold text-foreground">Envie sua mensagem</h2>
