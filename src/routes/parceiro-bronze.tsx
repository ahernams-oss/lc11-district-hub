...
const DEFAULTS = {
  ...
  title: "Parceiro Bronze",
  description: "O primeiro passo para apoiar as campanhas do programa Conexão Solidária do Distrito LC-11.",
  intro:
    "O Parceiro Bronze é a porta de entrada do programa Conexão Solidária, ideal para empresas, instituições e pessoas que desejam começar a apoiar as campanhas sociais do Distrito LC-11.\n\nToda contribuição, em qualquer nível, transforma vidas nas comunidades atendidas pelos Lions Clubes.",
  highlights_title: "Benefícios e reconhecimento",
  highlights:
    "Reconhecimento como apoiador das campanhas do distrito\nCertificado de parceria\nAgradecimento público nos canais oficiais\nInformações sobre o impacto das ações apoiadas",
  footer_text: "Quer ser um Parceiro Bronze do Distrito LC-11? Entre em contato e vamos conversar.",
  image_url: "",
  partner_logos_title: "Nossos Parceiros Bronze",
  partner_logos: [] as string[],
  partner_logos_links: [] as string[],
};

export const Route = createFileRoute("/parceiro-bronze")({
  head: () => ({
    meta: [
      { title: "Parceiro Bronze — Distrito LC-11" },
      { name: "description", content: "O primeiro passo para apoiar as campanhas do programa Conexão Solidária do Distrito LC-11." },
      { property: "og:title", content: "Parceiro Bronze — Distrito LC-11" },
      { property: "og:description", content: "O primeiro passo para apoiar as campanhas do programa Conexão Solidária do Distrito LC-11." },
    ],
  }),
  component: ParceiroBronzePage,
});

function ParceiroBronzePage() {
  const c = useSiteContent("parceiro-bronze", DEFAULTS);
