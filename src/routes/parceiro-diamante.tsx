...
const DEFAULTS = {
  ...
  description: "A aliança estratégica de mais alto nível do programa Conexão Solidária do Distrito LC-11.",
  intro:
    "O Parceiro Diamante é a categoria máxima de parceria do Conexão Solidária, reservada a empresas e instituições que assumem um compromisso estratégico de longo prazo com as ações sociais do Distrito LC-11.\n\nEssa aliança multiplica o impacto das campanhas e projetos dos Lions Clubes em todas as regiões do distrito.",
...
export const Route = createFileRoute("/parceiro-diamante")({
  head: () => ({
    meta: [
      { title: "Parceiro Diamante — Distrito LC-11" },
      { name: "description", content: "Aliança estratégica de mais alto nível do programa Conexão Solidária do Distrito LC-11." },
      { property: "og:title", content: "Parceiro Diamante — Distrito LC-11" },
      { property: "og:description", content: "Aliança estratégica de mais alto nível do programa Conexão Solidária do Distrito LC-11." },
    ],
  }),
  component: ParceiroDiamantePage,
});

function ParceiroDiamantePage() {
  const c = useSiteContent("parceiro-diamante", DEFAULTS);
